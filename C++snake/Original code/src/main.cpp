...
namespace GameObjects
{
    ...
    public:
        ...
        //std::vector<std::tuple<int,int,std::string>> history;
        //std::deque<std::tuple<int,int,std::string>> history;
        ...
        void add(const std::tuple<int,int,std::string>& state)
        {
            ...
            //int current_length = this->history.size();
            //this->history.push_back(state);
            //this->history  = {this->history.begin()+this->history.size()-current_length,
            //                  this->history.end()};
        }
        ...
        void set_length(const int& new_length)
        {
            ...
            //this->history.resize(new_length);
            this->length = new_length;
            //assert(this->history.capacity() == this->length);
            //assert(this->history.size() == this->length);
        }
    ...
    public:
        ...
        void add_body_block()
        {
            ...
            assert(body_rect.get_left() >= 0);
            assert(body_rect.get_top() >= 0);
...
int main()
{
    ...
    test_env.view();
    test_env.snake.history.view_history();
