...
class DeepQNetwork(torch.nn.Module):
    def __init__(self, lr: float, input_size: int,
        ...
        self.lin2 = torch.nn.Linear(in_features=self.input_size*20, out_features=self.input_size*40)
        self.lin3 = torch.nn.Linear(in_features=self.input_size*40, out_features=self.nr_actions)
